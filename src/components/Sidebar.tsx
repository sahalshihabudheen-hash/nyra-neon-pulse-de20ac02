import { Home, Search, ListMusic, Heart, Settings, Menu, X, Users, Shield, Gamepad2, Sparkles, AlertTriangle, Wand2, Headphones } from 'lucide-react';
...
const Sidebar = ({ activeTab, onTabChange }: SidebarProps) => {
  ...
  const allMenuItems = [
    ...
    { id: 'dj', label: 'DJ Mode', icon: Headphones, path: '/dj' },
